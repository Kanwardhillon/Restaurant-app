...
const RowContainer = ({ flag, data, scrollValue }) => {
  ...
  return (
    <div ref={RowContainer} className={`w-full my-12 flex items-center gap-3
    ${flag ? 'overflow-x-scroll scrollbar-none' : 'overflow-x-hidden flex-wrap scroll-smooth'
      }`}>
      {data && data.length > 0 ? data.map(item => (
        ...
        <p className='text-xl text-headingColor font-semibold my-2'>Items nor available</p>
      </div>}
