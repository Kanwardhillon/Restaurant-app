                            ...
                            onClick={login} />
                        {
                            isMenu && (
                                <motion.div
                                    ...
                                    >
                                    {user && user.email === 'dhillonkanwarpal57@gmail.com' && (
                                        <Link to='/createItem'>
                        ...
                        onClick={login} />
                    {
                        isMenu && (
                            <motion.div
                                ...
                                {user && user.email === 'dhillonkanwarpal57@gmail.com' && (
                                    <Link to='/createItem'>
                                        <p className='px-4 py-2 flex items-center cursor-pointer hover:bg-slate-100
                                             transition-all duration-100 ease-in-out text-textColor text-base'>
                                            New Item <MdAdd />
                                        </p>
                                    </Link>
                                ...
                                <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center
                                    bg-gray-200 gap-3 cursor-pointer hover:bg-slate-300
                                     transition-all duration-100 ease-in-out text-textColor text-base'
                                    onClick={logout}>
                                    Logout <MdLogout />
                                </p>
